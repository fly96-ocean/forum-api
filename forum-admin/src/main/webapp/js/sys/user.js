$(function () {
    $("#jqGrid").Grid({
        ...
        colModel: [
            ...
            {label: '积分', name: 'points', width: 50},
            {
                label: '状态', name: 'status', width: 40, formatter: function (value) {
                    return value === 0 ?
    ...
    methods: {
        ...
        queryPointLog: function () {
            ...
            openWindow({
                title: '积分记录',
                type: 2,
                content: '../manage/pointLog.html?userId=' + id
            })
        },
        queryUserTicket: function () {
            var id = getSelectedRow("#jqGrid");
            if (id == null) {
                return;
            }
            openWindow({
                title: '乘车券',
                type: 2,
                content: '../manage/userTicket.html?userId=' + id
            })
        },
        getDept: function () {
            //加载部门树
